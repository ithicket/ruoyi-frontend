...
import {getConfig, delConfig, addConfig, updateConfig, refreshCache, pageConfig} from "@/api/system/config"
...
function getList() {
  loading.value = true
  pageConfig(addDateRange(queryParams.value, dateRange.value)).then(response => {
  ...
  proxy.$refs["configRef"].validate(valid => {
    if (valid) {
      if (form.value.configId != undefined) {
        updateConfig(form.value).then(_ => {
