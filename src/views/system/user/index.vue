        ...
        <pane size="84">
          <el-col>
            ...
            <el-row :gutter="10" class="mb8">
              <el-col :span="1.5" v-if="hasPermission('system:user:add')">
                <el-button type="primary" plain icon="Plus" @click="handleAdd">新增</el-button>
              </el-col>
              <el-col :span="1.5" v-if="hasPermission('system:user:edit')">
                <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate">修改</el-button>
              </el-col>
              <el-col :span="1.5" v-if="hasPermission('system:user:remove')">
                <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete">删除</el-button>
              </el-col>
              <el-col :span="1.5" v-if="hasPermission('system:user:import')">
                <el-button type="info" plain icon="Upload" @click="handleImport">导入</el-button>
              </el-col>
              <el-col :span="1.5" v-if="hasPermission('system:user:export')">
              ...
              <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
                <template #default="scope">
                  <el-tooltip content="修改" placement="top"
                              v-if="hasPermission('system:user:edit') && scope.row.userId !== 1">
                    <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"/>
                  </el-tooltip>
                  <el-tooltip content="删除" placement="top"
                              v-if="hasPermission('system:user:remove') && scope.row.userId !== 1">
                    <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"/>
                  </el-tooltip>
                  <el-tooltip content="重置密码" placement="top"
                              v-if="hasPermission('system:user:resetPwd') && scope.row.userId !== 1">
            ...
            <pagination v-show="total > 0" :total="total" v-model:page="pages.pageNum" v-model:limit="pages.pageSize"
                        @pagination="getList"/>
          </el-col>
        </pane>
      </splitpanes>
...
function handleDelete(row) {
  const tmp = row.userId ? [row.userId] : ids.value;
...
async function handleUpdate(row) {
  ...
  const data = {userId: row.userId || ids.value}
