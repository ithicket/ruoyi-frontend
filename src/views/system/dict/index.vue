...
import {getType, delType, addType, updateType, refreshCache, pageType} from "@/api/system/dict/type"
...
function getList() {
  loading.value = true
  pageType(addDateRange(queryParams.value, dateRange.value)).then(response => {
